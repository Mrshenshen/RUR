...
client = OpenAI(
      api_key="sk-cjBuykuMgmSggGCIVTRvy0FNCk9ZMDg2ftHFUK1ZUntSsNVG", # sk-cjBuykuMgmSggGCIVTRvy0FNCk9ZMDg2ftHFUK1ZUntSsNVG
      base_url="https://api.chatanywhere.com.cn/v1"
)
NUM_SECONDS_TO_SLEEP = 0.5

def get_response(prompt, model_name = "gpt-4", temperature=0.7, max_tokens=800, ):
    content = prompt
    cnt = 1
    while True:
        # print("Cnt: ", cnt)
