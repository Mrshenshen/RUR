'''
Copied from: https://github.com/BradyFU/Awesome-Multimodal-Large-Language-Models/tree/Evaluation/tools
'''
...
parser.add_argument('--results_dir', default='/your/path/to/mme/results', type=str)

eval_type_dict = {
    "Perception": ["existence", "position", "count", "color"], 
    "Cognition": [],
}
